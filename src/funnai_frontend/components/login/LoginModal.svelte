...
<div id="crypto-modal" tabindex="-1" aria-hidden="true" class="bg-gray-900/[.36] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[9999] justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
  <div class="relative p-6 w-full mx-auto flex items-center content-center max-w-sm max-h-full h-full">
    <!-- Modal content -->
    <div class="relative bg-[lightsteelblue] rounded-xl shadow">
      <!-- Modal header -->
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-center mb-4">
          <img src="/coin.webp" alt="Coin" class="w-24 h-24 object-contain" />
        </div>
        <h3 class="text-lg text-center font-semibold text-[#151b1e]">
          Connect wallet
        </h3>
        <p class="text-sm text-center font-normal text-[#151b1e]">
          Connect with one of our available wallet providers to get started with the funnAI experience.
        </p>
