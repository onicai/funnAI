<script lang="ts">
  ...
  import devincilogobit from "../assets/chat/devinci192.png";
...
<div class="flex items-start gap-2.5 mt-4">
  ...
  <div class="flex flex-col w-full max-w-full leading-1.5 px-4 py-3 border-gray-200 bg-gray-100 rounded-xl rounded-tr-none">
