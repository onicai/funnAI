...
<div class="agent-page">
  <div class="agent-container">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
      ...
      <!-- Right column: fixed viewport height so feed updates scroll internally -->
      <div
        class="agent-card !bg-agent-surface rounded-2xl p-0 mb-2 flex flex-col overflow-hidden text-gray-200
               min-h-[28rem] h-[min(42rem,calc(100vh-7.5rem))] lg:h-[calc(100vh-7.5rem)] lg:sticky lg:top-4"
      >
        <div class="relative z-[1] flex flex-col h-full min-h-0 bg-agent-surface">
          ...
          <div class="flex-shrink-0 px-4 pb-3">
            ...
            <p class="mt-2.5 text-xs font-normal text-gray-500 min-h-[2.5rem]">
              {#if !$store.isAuthed}
                {showAllEvents
          ...
          <div class="flex-1 overflow-hidden min-h-0 border-t border-white/[0.06]">
