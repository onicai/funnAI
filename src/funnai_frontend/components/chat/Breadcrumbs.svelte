...
{#if $showBreadcrumbs}
  <nav class="justify-between mb-8 px-4 py-3 text-gray-700 border-b border-t border-gray-200 sm:flex sm:px-5 bg-gray-50" aria-label="Breadcrumb">
    <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-2 rtl:space-x-reverse sm:mb-0">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 cursor-not-allowed text-sm font-medium text-gray-500 md:ms-2">{$currentPage}</span>
        </div>
      </li>
    </ol>
  </nav>
