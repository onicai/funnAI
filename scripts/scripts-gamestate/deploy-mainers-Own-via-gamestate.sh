...
# echo " "
echo "========================================================================"
echo "The timers are running! To stop the timers for the mAInerController $NEW_MAINER_OWN_CANISTER of type #Own, issue this command:"
echo " "
echo "dfx canister call $NEW_MAINER_OWN_CANISTER stopTimerExecutionAdmin --network $NETWORK_TYPE"
echo " "
echo "========================================================================"
echo " "
