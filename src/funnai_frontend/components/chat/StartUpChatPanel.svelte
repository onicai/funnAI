...
<div>
  <div class="flex flex-col justify-center w-full items-center">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-4 w-full">
      <div class="text-[#151b1e] bg-gray-100 hover:bg-gray-50 border-2 border-dotted border-[#f9c490] rounded-lg cursor-pointer"
      ...
      <div class="text-[#151b1e] bg-gray-100 hover:bg-gray-50 border-2 border-dotted border-[#a1c490] rounded-lg cursor-pointer"
           on:click={() => sendMessage(samplePrompt2)}>
        <div class="inline-flex items-center justify-between w-full p-3">
          <p class="w-full text-[#151b1e] text-sm font-normal">{samplePrompt2}</p>
        </div>
      </div>
      <div class="text-[#151b1e] bg-gray-100 hover:bg-gray-50 border-2 border-dotted border-[#f0e68c] rounded-lg cursor-pointer"
           on:click={() => sendMessage(samplePrompt3)}>
        <div class="inline-flex items-center justify-between w-full p-3">
          <p class="w-full text-[#151b1e] text-sm font-normal">{samplePrompt3}</p>
        </div>
      </div>
      <div class="text-[#151b1e] bg-gray-100 hover:bg-gray-50 border-2 border-dotted border-[#cb8bd0] rounded-lg cursor-pointer"
