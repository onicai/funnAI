...
<div bind:this={containerElement} class="share-menu-container relative">
  <button
    ...
    class="relative p-1 text-gray-500 hover:text-gray-300 transition-colors duration-200 rounded-md hover:bg-white/5 {showShareMenu ? 'pointer-events-none' : ''}"
  ...
  {#if showShareMenu}
    ...
    >
      ...
      <button
        ...
        class="w-full px-3 py-2 text-sm text-left text-gray-300 hover:bg-white/5 hover:text-white transition-colors flex items-center gap-2"
      >
