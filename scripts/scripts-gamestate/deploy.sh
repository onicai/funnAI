...
if [ "$NETWORK_TYPE" = "ic" ]; then
    ...
    SUBNET_SHARE_AGENT_CTRL="yinp6-35cfo-wgcd2-oc4ty-2kqpf-t4dul-rfk33-fsq3r-mfmua-m2ngh-jqe" # All share agents are on the same subnet
    SUBNET_SHARE_SERVICE_CTRL="yinp6-35cfo-wgcd2-oc4ty-2kqpf-t4dul-rfk33-fsq3r-mfmua-m2ngh-jqe"
