...
<section class="relative mx-auto w-full max-w-5xl px-2 sm:px-0 pt-6 sm:pt-10 pb-16 sm:pb-24 min-h-112 sm:min-h-136">
  <div class="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
    ...
    <img
      src="/landing-stars.png"
      alt=""
      class="absolute bottom-[12%] right-[10%] w-32 sm:w-40 mix-blend-screen opacity-65 select-none -rotate-12"
    />
  </div>
  ...
  <div class="relative text-center max-w-3xl mx-auto">
    ...
    <h1 class="text-[1.85rem] sm:text-4xl lg:text-[2.75rem] font-semibold tracking-tight text-white leading-[1.15]">
      Own your
      <span class="bg-linear-to-r from-[#ddd6fe] via-[#c4b5fd] to-[#653FC5] bg-clip-text text-transparent">autonomous agents</span>
  ...
  <div class="relative mt-10 sm:mt-14 grid grid-cols-1 xl:grid-cols-[11rem_minmax(0,28rem)_11rem] xl:justify-center gap-3 xl:gap-5 items-start">
    <!-- Floating metric -->
    <div class="order-2 xl:order-1 w-full rounded-2xl border border-white/8 bg-agent-surface/80 backdrop-blur-xl p-4 shadow-[0_18px_40px_-24px_rgba(101,63,197,0.45)] xl:mt-6">
    ...
    <div class="order-1 xl:order-2 relative overflow-hidden rounded-2xl border border-white/8 bg-agent-surface/85 backdrop-blur-xl shadow-[0_24px_64px_-28px_rgba(101,63,197,0.4)]">
      <div class="pointer-events-none absolute inset-0">
        <div class="absolute -top-16 left-1/2 h-32 w-56 -translate-x-1/2 rounded-full bg-agent-purple/20 blur-3xl"></div>
      </div>
      ...
      <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-t border-white/6 px-4 sm:px-5 py-3.5">
    ...
    <div class="order-3 flex flex-wrap xl:flex-col gap-2 justify-center xl:items-end xl:mt-10">
      <span class="inline-flex items-center rounded-xl border border-white/8 bg-agent-surface/80 backdrop-blur-xl px-3.5 py-2 text-[12px] font-medium text-gray-200 shadow-[0_12px_28px_-18px_rgba(0,0,0,0.65)]">
        Proof-of-AI-Work
      </span>
      <span class="inline-flex items-center rounded-xl border border-white/8 bg-agent-surface/80 backdrop-blur-xl px-3.5 py-2 text-[12px] font-medium text-gray-200 xl:translate-x-2">
        On-chain identity
      </span>
      <span class="inline-flex items-center rounded-xl border border-white/8 bg-agent-surface/80 backdrop-blur-xl px-3.5 py-2 text-[12px] font-medium text-gray-200">
        {#if metricsLoading}
          Internet Computer
